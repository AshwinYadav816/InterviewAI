...
export const useInterview = () => {
    ...
    const generateReport = async ({ jobDescription, selfDescription, resumeFile, planDuration }) => {
        setLoading(true)
        let response = null
        try {
            response = await generateInterviewReport({ jobDescription, selfDescription, resumeFile, planDuration })

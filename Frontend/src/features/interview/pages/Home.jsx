...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        if (!resumeFile && !selfDescription.trim()) {
            alert("Please upload a resume or add a self-description to continue.")
            return
        }
    ...
    if (loading) {
        return (
            <Loader
                message="Building your interview strategy"
                subtitle="Our AI is analyzing the role and your profile — this can take up to 30 seconds."
            />
        )
    }
    ...
    return (
        <div className='home-page'>
            ...
            <div className='home-topbar'>
                <span className='home-topbar__brand'><span className='highlight'>Interview</span>AI</span>
                <LogoutButton />
            </div>
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className={`dropzone ${resumeName ? 'dropzone--filled' : ''}`} htmlFor='resume'>
                                ...
                                <p className='dropzone__subtitle'>{resumeName ? 'Click to change file' : 'PDF only (Max 3MB)'}</p>
                                <input
                                    ref={resumeInputRef}
